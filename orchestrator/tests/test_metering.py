...
def test_record_appends_json_lines(tmp_path):
    ...
    record(s, "ev1", "dep-456", 800, 100, tokens_cached=512, now=1720000001.0)
    rows = read_usage(s, "ev1")
    assert rows == [
        {"event_id": "ev1", "deployment_id": "dep-123", "ts": 1720000000.0, "tokens_in": 900, "tokens_out": 150, "tokens_cached": 0},
        {"event_id": "ev1", "deployment_id": "dep-456", "ts": 1720000001.0, "tokens_in": 800, "tokens_out": 100, "tokens_cached": 512},
    ]
